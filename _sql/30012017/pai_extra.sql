...
--
ALTER TABLE `city`
  MODIFY `id_city_pk` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT dla tabeli `contact`
--
ALTER TABLE `contact`
  MODIFY `ID_CONTACT_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
--
-- AUTO_INCREMENT dla tabeli `image`
--
ALTER TABLE `image`
  MODIFY `ID_IMAGE_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT dla tabeli `localization`
--
ALTER TABLE `localization`
  MODIFY `ID_LOCALIZATION_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
-- AUTO_INCREMENT dla tabeli `logtable`
--
ALTER TABLE `logtable`
  MODIFY `id_logtable` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=314;
--
-- AUTO_INCREMENT dla tabeli `property`
--
ALTER TABLE `property`
  MODIFY `ID_PROPERTY_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT dla tabeli `session`
--
ALTER TABLE `session`
  MODIFY `ID_SESSION_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
--
-- AUTO_INCREMENT dla tabeli `space`
--
ALTER TABLE `space`
  MODIFY `ID_SPACE_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
...
--
ALTER TABLE `user`
  MODIFY `ID_USER_PK` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
--
...
--
ALTER TABLE `visit`
  MODIFY `id_visit_pk` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
